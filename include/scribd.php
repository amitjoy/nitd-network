...
/* $Id: scribd.php 1 2010-02-02 09:36:11Z SocialEngineAddOns $ */
/* Unofficial Scribd PHP Class library : THIS FILE HAS BEEN DOWNLOADED FROM THE SCRIBD.COM */
...
class Scribd {
   ...
   * @return array containing doc_id, access_key, and secret_password if nessesary.
   */
	public function uploadFromUrl($url, $doc_type = null, $access = null, $rev_id = null, $download = "view-only"){
   ...
   * @return string containing DISPLAYABLE", "DONE", "ERROR", or "PROCESSING" for the current document.
   */
	public function changeSettings($doc_ids, $title = null, $description = null, $access = null, $license = null, $print = 0, $parental_advisory = null, $show_ads = null, $tags = null){
		...
		$params['tags'] = $tags;
		$params['disable_print'] = ($print == 0) ? 1 : 0;
   ...
   */
	...
	* @return 
	*/
	public function getDownloadUrl($doc_id, $doc_type = "pdf"){
